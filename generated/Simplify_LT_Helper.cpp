...
Expr Simplify_LT(const Expr &a, const Expr &b, const Type &type, Simplify *simplifier) {
    ...
    if ((r0 = a.as<Broadcast>())) {
      if ((r1 = b.as<Ramp>())) {
        if (is_const_v(((const Ramp*)r1)->stride)) {
          if (evaluate_predicate(fold(can_prove((((const Broadcast*)r0)->value < (((const Ramp*)r1)->base + fold(min(0, (((const Ramp*)r1)->stride * (((const Ramp*)r1)->lanes - 1)))))), simplifier)))) {
            return true;
          }
          if (evaluate_predicate(fold(can_prove((((const Broadcast*)r0)->value >= (((const Ramp*)r1)->base + fold(max(0, (((const Ramp*)r1)->stride * (((const Ramp*)r1)->lanes - 1)))))), simplifier)))) {
            return false;
          }
        }
        if ((r2 = ((const Ramp*)r1)->base.as<Add>())) {
          if (equal(((const Broadcast*)r0)->value, ((const Add*)r2)->a)) {
            return (0 < ramp(((const Add*)r2)->b, ((const Ramp*)r1)->stride, ((const Ramp*)r1)->lanes));
          }
          if (equal(((const Broadcast*)r0)->value, ((const Add*)r2)->b)) {
            return (0 < ramp(((const Add*)r2)->a, ((const Ramp*)r1)->stride, ((const Ramp*)r1)->lanes));
          }
        }
        if ((r2 = ((const Ramp*)r1)->base.as<Sub>())) {
          if (equal(((const Broadcast*)r0)->value, ((const Sub*)r2)->a)) {
            if (evaluate_predicate(fold(!(is_const(((const Broadcast*)r0)->value, 0))))) {
              return (0 < ramp((0 - ((const Sub*)r2)->b), ((const Ramp*)r1)->stride, ((const Ramp*)r1)->lanes));
            }
          }
        }
      }
      if ((r1 = ((const Broadcast*)r0)->value.as<Add>())) {
        if ((r2 = b.as<Ramp>())) {
          if ((r3 = ((const Ramp*)r2)->base.as<Add>())) {
            if (equal(((const Add*)r1)->a, ((const Add*)r3)->a)) {
              return (broadcast(((const Add*)r1)->b, ((const Ramp*)r2)->lanes) < ramp(((const Add*)r3)->b, ((const Ramp*)r2)->stride, ((const Ramp*)r2)->lanes));
            }
            if (equal(((const Add*)r1)->a, ((const Add*)r3)->b)) {
              return (broadcast(((const Add*)r1)->b, ((const Ramp*)r2)->lanes) < ramp(((const Add*)r3)->a, ((const Ramp*)r2)->stride, ((const Ramp*)r2)->lanes));
            }
            if (equal(((const Add*)r1)->b, ((const Add*)r3)->a)) {
              return (broadcast(((const Add*)r1)->a, ((const Ramp*)r2)->lanes) < ramp(((const Add*)r3)->b, ((const Ramp*)r2)->stride, ((const Ramp*)r2)->lanes));
            }
            if (equal(((const Add*)r1)->b, ((const Add*)r3)->b)) {
              return (broadcast(((const Add*)r1)->a, ((const Ramp*)r2)->lanes) < ramp(((const Add*)r3)->a, ((const Ramp*)r2)->stride, ((const Ramp*)r2)->lanes));
            }
          }
          if (equal(((const Add*)r1)->a, ((const Ramp*)r2)->base)) {
            return (broadcast(((const Add*)r1)->b, ((const Ramp*)r2)->lanes) < ramp(0, ((const Ramp*)r2)->stride, ((const Ramp*)r2)->lanes));
          }
          if (equal(((const Add*)r1)->b, ((const Ramp*)r2)->base)) {
            return (broadcast(((const Add*)r1)->a, ((const Ramp*)r2)->lanes) < ramp(0, ((const Ramp*)r2)->stride, ((const Ramp*)r2)->lanes));
          }
        }
      }
      if ((r1 = ((const Broadcast*)r0)->value.as<Sub>())) {
        if ((r2 = b.as<Ramp>())) {
          if ((r3 = ((const Ramp*)r2)->base.as<Sub>())) {
            if (equal(((const Sub*)r1)->a, ((const Sub*)r3)->a)) {
              if (evaluate_predicate(fold(!(is_const(((const Sub*)r1)->a, 0))))) {
                return (broadcast((0 - ((const Sub*)r1)->b), ((const Ramp*)r2)->lanes) < ramp((0 - ((const Sub*)r3)->b), ((const Ramp*)r2)->stride, ((const Ramp*)r2)->lanes));
              }
            }
            if (equal(((const Sub*)r1)->b, ((const Sub*)r3)->b)) {
              return (broadcast(((const Sub*)r1)->a, ((const Ramp*)r2)->lanes) < ramp(((const Sub*)r3)->a, ((const Ramp*)r2)->stride, ((const Ramp*)r2)->lanes));
            }
          }
          if (equal(((const Sub*)r1)->a, ((const Ramp*)r2)->base)) {
            if (evaluate_predicate(fold(!(is_const(((const Sub*)r1)->a, 0))))) {
              return (broadcast((0 - ((const Sub*)r1)->b), ((const Ramp*)r2)->lanes) < ramp(0, ((const Ramp*)r2)->stride, ((const Ramp*)r2)->lanes));
            }
          }
        }
      }
  ...
  if ((r0 = a.as<Broadcast>())) {
    if ((r1 = b.as<Broadcast>())) {
      return broadcast((((const Broadcast*)r0)->value < ((const Broadcast*)r1)->value), c0);
    }
  }
  if ((r0 = a.as<Mod>())) {
    if (is_const_int(b, 1)) {
