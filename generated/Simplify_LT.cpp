  ...
  if (expr->is_operand_no_overflow()) {
    if (const LT *a12 = expr.as<LT>()) {
      ...
      if (const Broadcast *a19 = a12->a.as<Broadcast>()) {
        if (is_const(a19->lanes)) {
          if (const Ramp *a20 = a12->b.as<Ramp>()) {
            if (is_const(a20->stride)) {
      ...
      if (is_const(a12->a)) {
        ...
        if (const Select *a531 = a12->b.as<Select>()) {
          if (is_const(a531->true_value)) {
            if (is_const(a531->false_value)) {
              return select(a531->cond, fold((a12->a < a531->true_value)), fold((a12->a < a531->false_value)));
            }
          }
        }
      }
      ...
      if (const Add *a52 = a12->b.as<Add>()) {
        ...
        if (const Select *a488 = a52->a.as<Select>()) {
          if (const Add *a489 = a488->true_value.as<Add>()) {
            if (equal(a12->a, a489->a)) {
              if (is_const(a489->b)) {
                if (is_const(a52->b)) {
                  if (evaluate_predicate(fold(((a489->b + a52->b) <= 0)))) {
                    return (!(a488->cond) && (a12->a < (a488->false_value + a52->b)));
                  }
                  if (evaluate_predicate(fold(((a489->b + a52->b) > 0)))) {
                    return (a488->cond || (a12->a < (a488->false_value + a52->b)));
                  }
          ...
          if (const Add *a497 = a488->false_value.as<Add>()) {
            if (equal(a12->a, a497->a)) {
              if (is_const(a497->b)) {
                if (is_const(a52->b)) {
                  if (evaluate_predicate(fold(((a497->b + a52->b) <= 0)))) {
                    return (a488->cond && (a12->a < (a488->true_value + a52->b)));
                  }
                  if (evaluate_predicate(fold(((a497->b + a52->b) > 0)))) {
                    return (!(a488->cond) || (a12->a < (a488->true_value + a52->b)));
                  }
      ...
      if (const Select *a475 = a12->b.as<Select>()) {
        if (const Add *a476 = a475->true_value.as<Add>()) {
          if (equal(a12->a, a476->a)) {
            if (is_const(a476->b)) {
              if (evaluate_predicate(fold((a476->b <= 0)))) {
                return (!(a475->cond) && (a12->a < a475->false_value));
              }
              if (evaluate_predicate(fold((a476->b > 0)))) {
                return (a475->cond || (a12->a < a475->false_value));
              }
        ...
        if (const Add *a482 = a475->false_value.as<Add>()) {
          if (equal(a12->a, a482->a)) {
            if (is_const(a482->b)) {
              if (evaluate_predicate(fold((a482->b <= 0)))) {
                return (a475->cond && (a12->a < a475->true_value));
              }
              if (evaluate_predicate(fold((a482->b > 0)))) {
                return (!(a475->cond) || (a12->a < a475->true_value));
              }
      ...
      if (const Select *a503 = a12->a.as<Select>()) {
        if (const Add *a504 = a503->true_value.as<Add>()) {
          if (is_const(a504->b)) {
            if (equal(a504->a, a12->b)) {
              if (evaluate_predicate(fold((a504->b >= 0)))) {
                return (!(a503->cond) && (a503->false_value < a504->a));
              }
              if (evaluate_predicate(fold((a504->b < 0)))) {
                return (a503->cond || (a503->false_value < a504->a));
              }
              ...
              if (equal(a504->a, a517->a)) {
                if (is_const(a517->b)) {
                  if (evaluate_predicate(fold((a504->b >= a517->b)))) {
                    return (!(a503->cond) && (a503->false_value < (a504->a + a517->b)));
                  }
                  if (evaluate_predicate(fold((a504->b < a517->b)))) {
                    return (a503->cond || (a503->false_value < (a504->a + a517->b)));
                  }
        ...
        if (const Add *a510 = a503->false_value.as<Add>()) {
          if (is_const(a510->b)) {
            if (equal(a510->a, a12->b)) {
              if (evaluate_predicate(fold((a510->b >= 0)))) {
                return (a503->cond && (a503->true_value < a510->a));
              }
              if (evaluate_predicate(fold((a510->b < 0)))) {
                return (!(a503->cond) || (a503->true_value < a510->a));
              }
              ...
              if (equal(a510->a, a525->a)) {
                if (is_const(a525->b)) {
                  if (evaluate_predicate(fold((a510->b >= a525->b)))) {
                    return (a503->cond && (a503->true_value < (a510->a + a525->b)));
                  }
                  if (evaluate_predicate(fold((a510->b < a525->b)))) {
                    return (!(a503->cond) || (a503->true_value < (a510->a + a525->b)));
                  }
        ...
        if (is_const(a503->true_value)) {
          if (is_const(a503->false_value)) {
            if (is_const(a12->b)) {
              return select(a503->cond, fold((a503->true_value < a12->b)), fold((a503->false_value < a12->b)));
            }
          }
        }
      }
      ...
      if (const Ramp *a1204 = a283->a.as<Ramp>()) {
        if (const Add *a1205 = a1204->base.as<Add>()) {
          if (const Mul *a1206 = a1205->a.as<Mul>()) {
            if (is_const(a1206->b)) {
              if (is_const(a1205->b)) {
                if (is_const(a1204->stride)) {
                  if (is_const(a1204->lanes)) {
