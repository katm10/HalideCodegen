...
Expr Simplify_Add(const Expr &a, const Expr &b, const Type &type, Simplify *simplifier) {
  ...
  if ((r0 = a.as<Ramp>())) {
    ...
    if ((r1 = ((const Ramp*)r0)->base.as<Broadcast>())) {
      if ((r2 = b.as<Broadcast>())) {
        if (evaluate_predicate(fold((c2 == (c0 * ((const Ramp*)r0)->lanes))))) {
          return ramp(broadcast((((const Broadcast*)r1)->value + ((const Broadcast*)r2)->value), c0), ((const Ramp*)r0)->stride, ((const Ramp*)r0)->lanes);
        }
      }
    }
    if ((r1 = ((const Ramp*)r0)->base.as<Ramp>())) {
      if ((r2 = b.as<Broadcast>())) {
        if (evaluate_predicate(fold((c2 == (((const Ramp*)r1)->lanes * ((const Ramp*)r0)->lanes))))) {
  ...
  if ((r0 = a.as<Broadcast>())) {
    if ((r1 = b.as<Broadcast>())) {
      if (evaluate_predicate(fold(((c1 % c0) == 0)))) {
        return broadcast((((const Broadcast*)r0)->value + broadcast(((const Broadcast*)r1)->value, fold((c1 / c0)))), c0);
        return broadcast((((const Broadcast*)r1)->value + broadcast(((const Broadcast*)r0)->value, fold((c1 / c0)))), c0);
      }
    }
  }
  if ((r0 = a.as<Add>())) {
    if ((r1 = ((const Add*)r0)->b.as<Broadcast>())) {
      if ((r2 = b.as<Broadcast>())) {
        if (evaluate_predicate(fold(((c1 % c0) == 0)))) {
          return (((const Add*)r0)->a + broadcast((((const Broadcast*)r1)->value + broadcast(((const Broadcast*)r2)->value, fold((c1 / c0)))), c0));
          return (((const Add*)r0)->a + broadcast((((const Broadcast*)r2)->value + broadcast(((const Broadcast*)r1)->value, fold((c1 / c0)))), c0));
        }
      }
    }
    if ((r1 = ((const Add*)r0)->a.as<Broadcast>())) {
      if ((r2 = b.as<Broadcast>())) {
        if (evaluate_predicate(fold(((c1 % c0) == 0)))) {
          return (((const Add*)r0)->b + broadcast((((const Broadcast*)r1)->value + broadcast(((const Broadcast*)r2)->value, fold((c1 / c0)))), c0));
          return (((const Add*)r0)->b + broadcast((((const Broadcast*)r2)->value + broadcast(((const Broadcast*)r1)->value, fold((c1 / c0)))), c0));
        }
      }
    }
  ...
  if ((r0 = a.as<Sub>())) {
    if ((r1 = ((const Sub*)r0)->b.as<Broadcast>())) {
      if ((r2 = b.as<Broadcast>())) {
        if (evaluate_predicate(fold(((c1 % c0) == 0)))) {
          return (((const Sub*)r0)->a + broadcast((broadcast(((const Broadcast*)r2)->value, fold((c1 / c0))) - ((const Broadcast*)r1)->value), c0));
          return (((const Sub*)r0)->a + broadcast((((const Broadcast*)r2)->value - broadcast(((const Broadcast*)r1)->value, fold((c1 / c0)))), c0));
        }
      }
    }
    if ((r1 = ((const Sub*)r0)->a.as<Broadcast>())) {
      if ((r2 = b.as<Broadcast>())) {
        if (evaluate_predicate(fold(((c1 % c0) == 0)))) {
          return (broadcast((((const Broadcast*)r1)->value + broadcast(((const Broadcast*)r2)->value, fold((c1 / c0)))), c0) - ((const Sub*)r0)->b);
          return (broadcast((((const Broadcast*)r2)->value + broadcast(((const Broadcast*)r1)->value, fold((c1 / c0)))), c0) - ((const Sub*)r0)->b);
        }
      }
    }
