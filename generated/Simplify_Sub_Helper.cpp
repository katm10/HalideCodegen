...
Expr Simplify_Sub(const Expr &a, const Expr &b, const Type &type, Simplify *simplifier) {
  ...
  if ((r0 = a.as<Broadcast>())) {
    if ((r1 = b.as<Ramp>())) {
      return ramp((((const Broadcast*)r0)->value - ((const Ramp*)r1)->base), (0 - ((const Ramp*)r1)->stride), ((const Ramp*)r1)->lanes);
    }
    if ((r1 = b.as<Broadcast>())) {
      ...
      if (evaluate_predicate(fold(((c1 % c0) == 0)))) {
        ...
        return broadcast((broadcast(((const Broadcast*)r0)->value, fold((c1 / c0))) - ((const Broadcast*)r1)->value), c0);
      }
    }
  }
  if ((r0 = a.as<Sub>())) {
    if ((r1 = ((const Sub*)r0)->b.as<Broadcast>())) {
      if ((r2 = b.as<Broadcast>())) {
        return (((const Sub*)r0)->a - broadcast((((const Broadcast*)r1)->value + ((const Broadcast*)r2)->value), c0));
      }
    }
  ...
  if ((r0 = a.as<Add>())) {
    if ((r1 = ((const Add*)r0)->b.as<Broadcast>())) {
      if ((r2 = b.as<Broadcast>())) {
        return (((const Add*)r0)->a + broadcast((((const Broadcast*)r1)->value - ((const Broadcast*)r2)->value), c0));
      }
    }
